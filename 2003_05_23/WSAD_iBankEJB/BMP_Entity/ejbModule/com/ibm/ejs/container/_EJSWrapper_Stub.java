...
TransactionalObject {
    ...
    public boolean wlmable() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("wlmable",EJSWrapper.class);
            if (so == null) {
                return wlmable();
            }
            try {
                return ((EJSWrapper)so.servant).wlmable();
            } catch (Throwable ex) {
    ...
    public EJBHome getEJBHome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_EJBHome",EJSWrapper.class);
            if (so == null) {
                return getEJBHome();
            }
            try {
                EJBHome result = ((EJSWrapper)so.servant).getEJBHome();
    ...
    public Handle getHandle() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_handle",EJSWrapper.class);
            if (so == null) {
                return getHandle();
            }
            try {
                Handle result = ((EJSWrapper)so.servant).getHandle();
    ...
    public Object getPrimaryKey() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_primaryKey",EJSWrapper.class);
            if (so == null) {
                return getPrimaryKey();
            }
            try {
                Object result = ((EJSWrapper)so.servant).getPrimaryKey();
    ...
    public boolean isIdentical(EJBObject arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("isIdentical",EJSWrapper.class);
            if (so == null) {
                return isIdentical(arg0);
            }
            try {
                EJBObject arg0Copy = (EJBObject) Util.copyObject(arg0,_orb());
                return ((EJSWrapper)so.servant).isIdentical(arg0Copy);
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void remove() throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove",EJSWrapper.class);
            if (so == null) {
                remove();
                return;
            }
            try {
                ((EJSWrapper)so.servant).remove();
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());

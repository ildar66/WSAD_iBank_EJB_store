...
public class _EJSRemoteBMPTransactionRecordHome_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPTransactionRecordHome target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPTransactionRecordHome) target;
    }
            ...
            switch (method.length()) {
                ...
                case 16: 
                    if (method.equals("findByPrimaryKey")) {
                        TransactionRecordKey arg0 = (TransactionRecordKey) in.read_value(TransactionRecordKey.class);
                        TransactionRecord result;
                        try {

...
public class _parameter_jsp_0 extends HttpJspBase {
    ...
    public final void _jspx_init() throws JasperException {
        ...
        int numStrings = 0;
        try {
            InputStream fin = this.getClass().getClassLoader().getResourceAsStream("html/ejbPage/_parameter_jsp_0.dat");

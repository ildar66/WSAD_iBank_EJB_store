...
public class _global_0005fnav_jsp_5 extends HttpJspBase {

    static char[][] _jspx_html_data = null;

    static {
    }
    public _global_0005fnav_jsp_5( ) {
    }
    ...
    public final void _jspx_init() throws JasperException {
        ...
        int numStrings = 0;
        try {
            InputStream fin = this.getClass().getClassLoader().getResourceAsStream("html/toolbar/_global_0005fnav_jsp_5.dat");

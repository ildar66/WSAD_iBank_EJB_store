...
public class _EJSRemoteCMPTransRecordHome_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPTransRecordHome target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPTransRecordHome) target;
    }
            ...
            switch (method.length()) {
                ...
                case 16: 
                    if (method.equals("findByPrimaryKey")) {
                        TransRecordKey arg0 = (TransRecordKey) in.read_value(TransRecordKey.class);
                        TransRecord result;
                        try {
                ...
                case 26: 
                    if (method.equals("create__java_sql_Timestamp")) {
                ...
                case 68: 
                    if (method.equals("create__CORBA_WStringValue__java_math_BigDecimal__CORBA_WStringValue")) {

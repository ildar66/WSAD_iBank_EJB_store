...
public class _EJSRemoteCMPCustomerHome_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteCMPCustomerHome target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteCMPCustomerHome) target;
    }
            ...
            switch (method.length()) {
                ...
                case 16: 
                    if (method.equals("findByPrimaryKey")) {
                        CustomerKey arg0 = (CustomerKey) in.read_value(CustomerKey.class);
                        Customer result;
                        try {
                ...
                case 112: 
                    if (method.equals("create__long__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue__CORBA_WStringValue")) {
                        int arg0 = in.read_long();

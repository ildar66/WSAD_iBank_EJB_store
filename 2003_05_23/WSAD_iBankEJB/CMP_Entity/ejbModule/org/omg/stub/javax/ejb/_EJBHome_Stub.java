...
public class _EJBHome_Stub extends Stub implements EJBHome {
    ...
    public EJBMetaData getEJBMetaData() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_EJBMetaData",EJBHome.class);
            if (so == null) {
                return getEJBMetaData();
            }
            try {
                EJBMetaData result = ((EJBHome)so.servant).getEJBMetaData();
    ...
    public HomeHandle getHomeHandle() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_homeHandle",EJBHome.class);
            if (so == null) {
                return getHomeHandle();
            }
            try {
                HomeHandle result = ((EJBHome)so.servant).getHomeHandle();
    ...
    public void remove(Object arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__java_lang_Object",EJBHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
            try {
                ...
                ((EJBHome)so.servant).remove(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public void remove(Handle arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__javax_ejb_Handle",EJBHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }

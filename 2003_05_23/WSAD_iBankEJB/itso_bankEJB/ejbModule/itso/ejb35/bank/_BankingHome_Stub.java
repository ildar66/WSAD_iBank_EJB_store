...
public class _BankingHome_Stub extends Stub implements BankingHome {
    
    private static final String[] _type_ids = {
        "RMI:itso.ejb35.bank.BankingHome:0000000000000000", 
    ...
    public EJBMetaData getEJBMetaData() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_EJBMetaData",BankingHome.class);
            if (so == null) {
                return getEJBMetaData();
            }
            try {
                EJBMetaData result = ((BankingHome)so.servant).getEJBMetaData();
    ...
    public HomeHandle getHomeHandle() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_homeHandle",BankingHome.class);
            if (so == null) {
                return getHomeHandle();
            }
            try {
                HomeHandle result = ((BankingHome)so.servant).getHomeHandle();
    ...
    public void remove(Object arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__java_lang_Object",BankingHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
            try {
                ...
                ((BankingHome)so.servant).remove(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public void remove(Handle arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__javax_ejb_Handle",BankingHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
        ...
        if (!Util.isLocal(this)) {
            try {
                ...
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Banking) in.read_Object(Banking.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",BankingHome.class);
            if (so == null) {
                return create();
            }
            try {
                Banking result = ((BankingHome)so.servant).create();
                return (Banking)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());

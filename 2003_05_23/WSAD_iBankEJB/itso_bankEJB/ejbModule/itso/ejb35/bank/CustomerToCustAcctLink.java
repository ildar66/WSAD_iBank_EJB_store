...
import javax.ejb.*;
import javax.naming.*;
public class CustomerToCustAcctLink extends SingleToManyLink {
...
public CustomerToCustAcctLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((itso.ejb35.bank.CustAcct)anEJB).getCustomerKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((itso.ejb35.bank.CustAcctHome)getTargetHome(this)).findCustAcctByCustomer((itso.ejb35.bank.CustomerKey)getEntityContext().getPrimaryKey());
	}
...
public javax.ejb.EntityContext getEntityContext() {
	return ((itso.ejb35.bank.CustomerBean)source).getEntityContext();
}
/**

...
public class CheckingAccessBean extends com.ibm.ivj.ejb.runtime.AbstractEntityAccessBean implements CheckingAccessBeanData {

    transient private itso.ejb35.bank.Checking __ejbRef = null;
    ...
    *
    * public abstract itso.ejb35.bank.Checking itso.ejb35.bank.CheckingHome.findByPrimaryKey(itso.ejb35.bank.BankAccountKey) throws java.rmi.RemoteException,javax.ejb.FinderException
    *
    ...
    */
    ...
    public CheckingAccessBean ( javax.ejb.EJBObject o ) throws java.rmi.RemoteException {
        super(o);
    }
    ...
    */
    ...
    public CheckingAccessBean(java.lang.String arg0, java.math.BigDecimal arg1) throws javax.ejb.CreateException, java.rmi.RemoteException, javax.naming.NamingException {
    ...
    */
    ...
    public java.util.Enumeration findAccountsForCustomer(int arg0) throws java.rmi.RemoteException, javax.ejb.FinderException, javax.naming.NamingException {
        itso.ejb35.bank.CheckingHome localHome = ejbHome();
    ...
    */
    ...
    private itso.ejb35.bank.CheckingHome ejbHome() throws java.rmi.RemoteException, javax.naming.NamingException {
        return (itso.ejb35.bank.CheckingHome) PortableRemoteObject.narrow(getHome(), itso.ejb35.bank.CheckingHome.class);
    }
    ...
    */
    ...
    private itso.ejb35.bank.Checking ejbRef() throws java.rmi.RemoteException {
        if ( ejbRef == null )
            return null;
        if ( __ejbRef == null )
            __ejbRef = (itso.ejb35.bank.Checking) PortableRemoteObject.narrow(ejbRef, itso.ejb35.bank.Checking.class);
    ...
    */
    ...
    public java.math.BigDecimal getOverdraft() throws java.rmi.RemoteException, javax.ejb.CreateException, javax.ejb.FinderException, javax.naming.NamingException {
        return (((java.math.BigDecimal) __getCache("overdraft")));
    }

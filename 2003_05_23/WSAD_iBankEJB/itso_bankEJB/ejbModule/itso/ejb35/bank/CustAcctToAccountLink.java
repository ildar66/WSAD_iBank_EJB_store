...
import javax.ejb.*;
import javax.naming.*;
public class CustAcctToAccountLink extends ManyToSingleLink {
...
public CustAcctToAccountLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
protected javax.ejb.EJBObject fetchTarget() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	itso.ejb35.bank.BankAccountKey key = ((itso.ejb35.bank.CustAcctBean)source).getAccountKey();
	try {
...
protected boolean isKeyValid() {
	return (((itso.ejb35.bank.CustAcctBean)source).getAccountKey() != null);
}
/**
 * Reset my target key.
 * @exception java.rmi.RemoteException The exception description.
...
protected void resetKey() throws java.rmi.RemoteException {
	((itso.ejb35.bank.CustAcctBean)source).privateSetAccountKey(null);
}
/**
...
public void secondaryAddElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((itso.ejb35.bank.BankAccount)anEJB).secondaryAddCustAcct((itso.ejb35.bank.CustAcct)getEntityContext().getEJBObject());
}
/**
 * Forward inverse maintenance through my target EJB.
 * @param anEJB javax.ejb.EJBObject
...
public void secondaryRemoveElementCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((itso.ejb35.bank.BankAccount)anEJB).secondaryRemoveCustAcct((itso.ejb35.bank.CustAcct)getEntityContext().getEJBObject());
}
/**
...
public void set(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	...
	if (targetEJB == null)
		...
		((itso.ejb35.bank.CustAcctBean)source).privateSetAccountKey((itso.ejb35.bank.BankAccountKey)targetEJB.getPrimaryKey());
}
}

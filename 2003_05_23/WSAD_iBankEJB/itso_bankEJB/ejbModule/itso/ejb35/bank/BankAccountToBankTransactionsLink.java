...
public BankAccountToBankTransactionsLink(javax.ejb.EntityBean anEntityBean) {
	super(anEntityBean);
	isRequired = true;
}
/**
...
public void addElement(javax.ejb.EJBObject targetEJB) throws java.rmi.RemoteException {
	if (targetEJB != null) {
		...
		((itso.ejb35.bank.TransRecord)targetEJB).privateSetOwningAccountKey((itso.ejb35.bank.BankAccountKey)getEntityContext().getPrimaryKey());
	}
}
/**
...
protected boolean currentlyContains(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	return (	super.currentlyContains(anEJB)
			||	getEntityContext().getPrimaryKey()
						.equals(((itso.ejb35.bank.TransRecord)anEJB).getOwningAccountKey()));
}
/**
...
protected java.util.Enumeration fetchTargetEnumeration() throws java.rmi.RemoteException, javax.ejb.FinderException {
	...
	try {
		enum = ((itso.ejb35.bank.TransRecordHome)getTargetHome(this)).findBankTransactionsByOwningAccount((itso.ejb35.bank.BankAccountKey)getEntityContext().getPrimaryKey());
	}
 ...
 * @return itso.ejb35.bank.TransRecordHome
 * @param aLink com.ibm.ivj.ejb.associations.links.Link
 * @exception javax.naming.NamingException The exception description.
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
protected static synchronized TransRecordHome getTargetHome(com.ibm.ivj.ejb.associations.links.Link aLink) throws javax.naming.NamingException {
	if (targetHome == null) {
		String homeName = aLink.getEntityContext().getEnvironment().getProperty(targetHomeName);
		if (homeName == null)
			homeName = targetHomeName;
		targetHome = (itso.ejb35.bank.TransRecordHome)lookupTargetHome(homeName, itso.ejb35.bank.TransRecordHome.class);
	}
	return targetHome;
}
/**
...
protected javax.ejb.EJBObject narrowElement(java.lang.Object element) throws java.rmi.RemoteException {
	return (EJBObject)javax.rmi.PortableRemoteObject.narrow(element, itso.ejb35.bank.TransRecord.class);
}
/**
...
public void secondarySetCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((itso.ejb35.bank.TransRecord)anEJB).secondarySetOwningAccount((itso.ejb35.bank.BankAccount)getEntityContext().getEJBObject());
}
/**
...
public void secondarySetNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((itso.ejb35.bank.TransRecord)anEJB).secondarySetOwningAccount(null);
}
/**
 * Send my counterLink #secondaryDisconnect by routing through my target EJB
 * @param anEJB javax.ejb.EJBObject
...
public void setNullCounterLinkOf(javax.ejb.EJBObject anEJB) throws java.rmi.RemoteException {
	if (anEJB != null)
		((itso.ejb35.bank.TransRecord)anEJB).setOwningAccount(null);
}
}

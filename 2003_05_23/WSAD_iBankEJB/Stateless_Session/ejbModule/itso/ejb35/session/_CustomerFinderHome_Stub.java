...
public class _CustomerFinderHome_Stub extends Stub implements CustomerFinderHome {
    ...
    public EJBMetaData getEJBMetaData() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_EJBMetaData",CustomerFinderHome.class);
            if (so == null) {
                return getEJBMetaData();
            }
            try {
                EJBMetaData result = ((CustomerFinderHome)so.servant).getEJBMetaData();
    ...
    public HomeHandle getHomeHandle() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_homeHandle",CustomerFinderHome.class);
            if (so == null) {
                return getHomeHandle();
            }
            try {
                HomeHandle result = ((CustomerFinderHome)so.servant).getHomeHandle();
    ...
    public void remove(Object arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__java_lang_Object",CustomerFinderHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
            try {
                ...
                ((CustomerFinderHome)so.servant).remove(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public void remove(Handle arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__javax_ejb_Handle",CustomerFinderHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
    ...
    public CustomerFinder create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CustomerFinder) in.read_Object(CustomerFinder.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",CustomerFinderHome.class);
            if (so == null) {
                return create();
            }
            try {
                CustomerFinder result = ((CustomerFinderHome)so.servant).create();
                return (CustomerFinder)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());

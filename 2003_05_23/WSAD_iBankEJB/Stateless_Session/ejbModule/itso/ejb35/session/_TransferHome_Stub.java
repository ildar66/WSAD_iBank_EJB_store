...
public class _TransferHome_Stub extends Stub implements TransferHome {
    
    private static final String[] _type_ids = {
        "RMI:itso.ejb35.session.TransferHome:0000000000000000", 
    ...
    public EJBMetaData getEJBMetaData() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_EJBMetaData",TransferHome.class);
            if (so == null) {
                return getEJBMetaData();
            }
            try {
                EJBMetaData result = ((TransferHome)so.servant).getEJBMetaData();
    ...
    public HomeHandle getHomeHandle() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_homeHandle",TransferHome.class);
            if (so == null) {
                return getHomeHandle();
            }
            try {
                HomeHandle result = ((TransferHome)so.servant).getHomeHandle();
    ...
    public void remove(Object arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__java_lang_Object",TransferHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
            try {
                ...
                ((TransferHome)so.servant).remove(arg0Copy);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public void remove(Handle arg0) throws RemoteException, RemoveException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("remove__javax_ejb_Handle",TransferHome.class);
            if (so == null) {
                remove(arg0);
                return;
            }
    ...
    public Transfer create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Transfer) in.read_Object(Transfer.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",TransferHome.class);
            if (so == null) {
                return create();
            }
            try {
                Transfer result = ((TransferHome)so.servant).create();
                return (Transfer)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
